...
const file_driver_proto_rawDesc = "" +
	...
	"\vpackageSlug\x18\x02 \x01(\tR\vpackageSlug\"\xda\x01\n" +
	"\x06Driver\x12\x0e\n" +
	...
	"\x16RegisterDriverResponse2\xb3\x01\n" +
	"\rDriverService\x12O\n" +
...
var file_driver_proto_depIdxs = []int32{
	...
	3, // 3: driver.DriverService.RegisterDriver:output_type -> driver.RegisterDriverResponse
	3, // 4: driver.DriverService.UnregisterDriver:output_type -> driver.RegisterDriverResponse
